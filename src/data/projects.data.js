...
Agi3.frames = [
  {
    layout: "Banner",
    contents: [Agi3.images.banner, Agi3.name, Agi3.client, Agi3.date],
  },
  {
    layout: "TextLeftImageRight",
    contents: [
      Agi3.images.banner,
      `<h2 class="fade-in-slide-up-300 mb-6"><span class="text-yellow-300">Agi3</span> is a self-serve insurance platform for farmers.</h2>
      <p class="fade-in-slide-up-350">The platform allows farmers to manage their crop plans, insurance policies, file claims, and more.</p>`,
    ],
  },
  {
    layout: "TextLeftTextRight",
    contents: [
      `<h2 class="fade-in-slide-up-300">The platform insures <span class="text-yellow-300">thousands of farms</span> annually.</h2>`,
      `<p class="fade-in-slide-up-350">The platform tackles a number of technical challenges, including a high-performance interactive map and robust handling of large and diverse datasets.</p>`,
    ],
  },
  {
    layout: "TextLeftTextRight",
    contents: [
      `<h2 class="fade-in-slide-up-300">Agi3 is built with React, Django, and Postgres.</h2>`,
      `<p class="fade-in-slide-up-350 mb-10">The platform is built and maintained by a small team. My role on the project was senior full-stack engineer.</p>
      <p class="fade-in-slide-up-400">
        <a class="button focusable" href="https://agi3.ai/" target="_blank">
...
const StoriApp = {
  ...
  id: "stori-app",
  description:
    "Stori app is a companion app for the Stori cannabis container. The app tracks your inventory and provides you with product details and offers.",
  images: {
    banner: {
...
export default [Actual, Agi3, StoriApp, Canniknow, CannedRetail, Highlife, Foglers];
