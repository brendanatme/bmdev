                ...
                <Link href={`/projects/${project.id}`}>
                  <div className={`${styles.project} rounded`}>
                    ...
                    <div className={`${styles.projectMeta} absolute bottom-0 left-0 py-2 px-3 md:py-5 md:px-10 w-full`}>
                      ...
                      <div className={`text-gray-700 text-copy-1 my-1 md:my-2 flex-1 leading-none ${styles.projectName}`}>{project.name}</div>
                      <div className={`text-gray-700 text-copy-2 my-1 md:my-2 flex-initial ${styles.projectClient}`}>{project.client}</div>
                      <div className={`text-gray-700 text-copy-2 my-1 md:my-2 flex-initial ${styles.projectDate}`}>{project.date}</div>
                    </div>
                  </div>
                </Link>
              </div>
            ...
            <div className="flex flex-wrap justify-evenly">
              {clients.map((client, i) => (
                ...
                >
                  ...
                  <div
                    className={`relative p-5 z-10 bg-white ${client.thumb.bg} opacity-${client.thumb.op} flex-grow flex flex-col justify-center`}
                  >
